...
WORKDIR /pkg
COPY . /pkg
# Read DESCRIPTION (Imports + Remotes) authoritatively so rmorie, rmoriedata,
# moriebricklayer and any future deps are all resolved from r-universe (binary
# where available) without hand-listing them here.
